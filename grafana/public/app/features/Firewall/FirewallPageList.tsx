...
export const FirewallPageList: FC = () => {
  const navIndex = useSelector((state: StoreState) => state.navIndex);
  const navModel = getNavModel(navIndex, 'firewall-list-rules');
      ...
      <Page.Contents>
        <>
          <div className="page-action-bar">
            ...
            <LinkButton icon="plus" href="firewall/">
              New Rule
            </LinkButton>
          </div>
...
export default FirewallPageList;
