...
export function getAppRoutes(): RouteDescriptor[] {
  return [
    ...
    // Firewall
    {
      path: '/firewall',
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "UserProfileEditPage" */ 'app/features/Firewall/FirewallPage')
      ),
    },
    {
      path: '/firewall/list',
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "UserProfileEditPage" */ 'app/features/Firewall/FirewallPageList')
      ),
    },
    {
      path: '/d/:uid/:slug?',
